    ...
    crates = {
      ...
      "automerge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "511a00c8c6d2c470da78a2acf9da1eaacbc1dbf2";
          sha256 = "0vyikxq3mm0ra7qb67yhzldma0pnn69rmwcaascx8yb97d2dda01";
        };
        authors = [
      ...
      "exp" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "89bb9e9996cea8290763a3bb7aa2d33fd4d57d29";
          sha256 = "0bdl6lpx1yxmdqi4njwkhvwrmrss8ip8l4hgrxrrpq9pwqhxndwz";
        };
        authors = [
          "Andrew Jeffery <dev@jeffas.io>"
        ];
