    ...
    crates = {
      ...
      "automerge" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "6b856874647653895a01e6e2b225298112e0120c";
          sha256 = "0ky85s79s429s88v6ww42knfaplw4fz9gkjbgi2ya8q8zicvbiaf";
        };
        authors = [
      ...
      "automerge-persistent-rocksdb" = rec {
        crateName = "automerge-persistent-rocksdb";
        version = "0.1.0";
        edition = "2018";
        workspace_member = null;
        src = pkgs.fetchgit {
      ...
      "ecetcd" = rec {
        ...
        dependencies = [
          ...
          {
            name = "automerge-persistent-rocksdb";
            packageId = "automerge-persistent-rocksdb";
          }
          {
      ...
      "exp" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "cb677aa2ac760cf64cf5eb3957e7bfc4cc9f79db";
          sha256 = "1x8ygzd5yijy1v862lk0gq20vms1wphrg7srjndijsd5pkq97gan";
        };
        authors = [
          "Andrew Jeffery <dev@jeffas.io>"
        ];
