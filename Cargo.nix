  ...
  internal = rec {
    ...
    crates = {
      ...
      "eckd" = rec {
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "macros" "rt" "rt-multi-thread" "fs" ];
          }
          {
            name = "tonic";
            packageId = "tonic";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "bytes" "default" "fs" "io-std" "io-util" "libc" "macros" "memchr" "mio" "net" "num_cpus" "rt" "rt-multi-thread" "sync" "time" "tokio-macros" ];
      };
      "tokio-macros" = rec {
